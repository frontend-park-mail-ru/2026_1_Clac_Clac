...
export const kanbanApi = {
  ...
  reorderSections: (boardLink: string, data: ListSectionLink) =>
    apiClient.patch<BaseResponse, ListSectionLink>(`/boards/${boardLink}/sections/reorder`, data),
  createSection: (data: CreateSectionRequest) =>
    apiClient.post<ApiResponse<SectionInfo>, CreateSectionRequest>("/sections", data),
  ...
  updateSection: (sectionLink: string, data: Partial<SectionInfo>) =>
    apiClient.put<BaseResponse, Partial<SectionInfo>>(`/sections/${sectionLink}`, data),
  ...
  createTask: (data: CreateCardRequest) =>
    apiClient.post<ApiResponse<CreateCardResponse>, CreateCardRequest>("/cards", data),
  ...
  reorderTask: (taskLink: string, data: ReorderCardsRequest) =>
    apiClient.patch<BaseResponse, ReorderCardsRequest>(`/cards/${taskLink}/reorder`, data),

  uploadAttachment: (taskLink: string, formData: FormData) =>
    apiClient.post<ApiResponse<AttachmentResponse>, FormData>(`/cards/${taskLink}/attachments`, formData),
  ...
  createComment: (taskLink: string, data: CreateCommentRequest) =>
    apiClient.post<ApiResponse<CreateCommentResponse>, CreateCommentRequest>(`/cards/${taskLink}/comments`, data),
  updateComment: (commentLink: string, data: UpdateCommentRequest) =>
    apiClient.put<BaseResponse, UpdateCommentRequest>(`/comments/${commentLink}`, data),
  ...
  createSubtask: (taskLink: string, data: CreateSubtaskRequest) =>
    apiClient.post<ApiResponse<SubtaskResponse>, CreateSubtaskRequest>(`/cards/${taskLink}/subtasks`, data),
  updateSubtask: (subtaskLink: string, data: UpdateSubtaskRequest) =>
    apiClient.put<BaseResponse, UpdateSubtaskRequest>(`/subtasks/${subtaskLink}`, data),
